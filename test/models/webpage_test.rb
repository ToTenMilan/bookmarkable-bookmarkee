...
class WebpageTest < ActiveSupport::TestCase
	...
	test 'it should return zero absolute path properly parsed' do
		assert_equal ['api.rubyonrails.org/', 'v5.2.1/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates'], Webpage.extract_domain_and_path(paths[0])
	end

	test 'it should return first absolute path properly parsed' do
		assert_equal ['api.rubyonrails.org/', 'v5.2.1/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates'], Webpage.extract_domain_and_path(paths[1])
	end
	...
	test 'it should return third absolute path properly parsed' do
		assert_equal ['api.rubyonrails.org/', 'v5.2.1/'], Webpage.extract_domain_and_path(paths[3])
	end

	test 'it should return fourth absolute path properly parsed' do
		assert_equal ['api.rubyonrails.org/', 'v5.2.1/'], Webpage.extract_domain_and_path(paths[4])
	end
	...
	test 'it should return sixth absolute path properly parsed' do
		assert_equal ['api.rubyonrails.org/', ''], Webpage.extract_domain_and_path(paths[6])
	end

	test 'it should return seventh absolute path properly parsed' do
		assert_equal ['api.rubyonrails.org/', ''], Webpage.extract_domain_and_path(paths[7])
	end
	...
	test 'it should return ninth absolute path properly parsed' do
		assert_equal ['api.rubyonrails.org', ''], Webpage.extract_domain_and_path(paths[9])
	end

	test 'it should return tenth absolute path properly parsed' do
		assert_equal ['api.rubyonrails.org', ''], Webpage.extract_domain_and_path(paths[10])
	end
	...
	test 'it should return twelfth absolute path properly parsed' do
		assert_equal ['rubyonrails.org', ''], Webpage.extract_domain_and_path(paths[12])
	end

	test 'it should return thirteenth absolute path properly parsed' do
		assert_equal ['rubyonrails.org', ''], Webpage.extract_domain_and_path(paths[13])
	end
	...
	test 'it should return fifteenth absolute path properly parsed' do
		assert_equal ['www.rubyonrails.org/', ''], Webpage.extract_domain_and_path(paths[15])
	end

	test 'it should return sixteenth absolute path properly parsed' do
		assert_equal ['www.rubyonrails.org/', ''], Webpage.extract_domain_and_path(paths[16])
	end
